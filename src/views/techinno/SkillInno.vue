        ...
        <div>
            ...
            <Modal
                ...
                <Form :model="formItem" :label-width="120">
                    ...
                    <FormItem label="项目领域" required>
                        <RadioGroup v-model="formItem.type" type="button">
                            <Radio label="生产设备操作">生产设备操作</Radio>
                            <Radio label="生产设备维修">生产设备维修</Radio>
                        </RadioGroup>
                    </FormItem>
                ...
                <Form :model="resultItem" :label-width="120">
                    ...
                    <FormItem label="项目领域" required>
                        <RadioGroup v-model="resultItem.type" type="button">
                            <Radio label="生产设备操作" disabled>生产设备操作</Radio>
                            <Radio label="生产设备维修" disabled>生产设备维修</Radio>
                        </RadioGroup>
                    </FormItem>
                    <FormItem label="项目负责人" required>
                    ...
                    <FormItem label="年度">
                        <DatePicker type="date" format="yyyy" placement="bottom-end" placeholder="选择年度" :value="resultItem.statusDate" @on-change="statusDateChange" readonly></DatePicker>
                        (立项/结题 年度)
                    </FormItem>
                    <FormItem label="获奖等级">
