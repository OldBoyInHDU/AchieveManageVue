<template>
    <div class="container" style="margin: 20px">
        ...
        <Divider style="padding-top: 20px">人才培养列表(保证3条数据)</Divider>
        <div class="table">
            <!--            人才培养登记modal-->
            <Modal
    ...
    methods: {
        ...
        submit() {
            ...
            request.post(
                ...
                res => {
                    console.log(res)
                    this.resetForm()
                    this.$Message.info('人才培养登记成功')
                }
            ).catch(
                err => {
                    console.log(err)
                    this.$Message.error('人才培养登记失败')
                }
            )
        },
        resetForm() {
        ...
        remove(index) {
            ...
            request.delete(
                ...
                res => {
                    this.$Message.success('人才培养删除成功！')
                }).catch(
                err => {
                    this.$Message.error('人才培养删除失败！请联系技术人员')
                }
            )
        },
        changePage(page) {
